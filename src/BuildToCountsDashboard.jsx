...
// Updated: Separate frozen and freeze-dried tracking for inventory and display
...
const initialData = [
  { name: "Beef Bash - Frozen", made: 60, sold: 45, expected: 0, inventory: 15 },
  { name: "Beef Bash - Freeze-Dried", made: 60, sold: 45, expected: 0, inventory: 15 },
  { name: "Gobble Gone - Frozen", made: 50, sold: 42, expected: 0, inventory: 8 },
  { name: "Gobble Gone - Freeze-Dried", made: 50, sold: 43, expected: 0, inventory: 7 },
  { name: "Savory Salmon - Frozen", made: 40, sold: 20, expected: 0, inventory: 20 },
  { name: "Savory Salmon - Freeze-Dried", made: 40, sold: 20, expected: 0, inventory: 20 },
  { name: "Pork Plate - Frozen", made: 35, sold: 27, expected: 0, inventory: 8 },
  { name: "Pork Plate - Freeze-Dried", made: 35, sold: 28, expected: 0, inventory: 7 },
  { name: "Cluckin' Good Chicken - Frozen", made: 30, sold: 15, expected: 0, inventory: 15 },
  { name: "Cluckin' Good Chicken - Freeze-Dried", made: 30, sold: 15, expected: 0, inventory: 15 },
  { name: "Blueberry Bkfst - Frozen", made: 25, sold: 10, expected: 0, inventory: 15 },
  { name: "Blueberry Bkfst - Freeze-Dried", made: 25, sold: 10, expected: 0, inventory: 15 }
];
